...
def display_title():
    title = r"""
 ________  ________  _______   ________  _________  ___  ________           ________  ________  _____ ______   ________  ___       ________   ________     
|\   ____\|\   __  \|\  ___ \ |\   ____\|\___   ___\\  \|\   ___  \        |\   ____\|\   __  \|\   _ \  _   \|\   __  \|\  \     |\   ___  \|\   ____\    
\ \  \___|\ \  \|\  \ \   __/|\ \  \___|\|___ \  \_\ \  \ \  \\ \  \       \ \  \___|\ \  \|\  \ \  \\\__\ \  \ \  \|\ /\ \  \    \ \  \\ \  \ \  \___|    
 \ \  \  __\ \   _  _\ \  \_|/_\ \_____  \   \ \  \ \ \  \ \  \\ \  \       \ \  \  __\ \   __  \ \  \\|__| \  \ \   __  \ \  \    \ \  \\ \  \ \  \  ___  
  \ \  \|\  \ \  \\  \\ \  \_|\ \|____|\  \   \ \  \ \ \  \ \  \\ \  \       \ \  \|\  \ \  \ \  \ \  \    \ \  \ \  \|\  \ \  \____\ \  \\ \  \ \  \|\  \ 
   \ \_______\ \__\\ _\\ \_______\____\_\  \   \ \__\ \ \__\ \__\\ \__\       \ \_______\ \__\ \__\ \__\    \ \__\ \_______\ \_______\ \__\\ \__\ \_______\
    \|_______|\|__|\|__|\|_______|\_________\   \|__|  \|__|\|__| \|__|        \|_______|\|__|\|__|\|__|     \|__|\|_______|\|_______|\|__| \|__|\|_______|
                                 \|_________|                                                                                                              
                                                                                                                                                           
                                                                                                                                                                                                                                                                                                      
    """
    print(Colors.RED + title + Colors.END)
...
class BlackjackGame:
            ...
            while True:
                ...
                if move == 'h':
                    ...
                    if player['hand'].is_bust():
                        ...
                        break  # End player's turn immediately
                elif move == 's':
    ...
    def select_players(self):
        while True:
            self.clear_screen()
            display_title()  # Display the ASCII Art Title above the main menu
